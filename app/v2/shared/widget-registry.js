...
export const registry = {
  ...
  // =====================================================================
  // CAT 15 — PENTACAD CAM (Phase 0/1/2/3 of the Pentacad roadmap)
  // 5-axis CAM kernel · Penta Machine post · Kinetic Control bridge
  // =====================================================================
  // -- Phase 0 + simulator headline --
  'pentacad-simulator':      { tier:6, minRole:'engineer', freeQuota:{calls:Infinity}, cost:{ load:5, play:5, replay:50 }, deps:['three','three/addons/controls/TrackballControls.js','three/addons/loaders/GLTFLoader.js','shared/cam/modal-executor.js','shared/machines/index.js'], status:'live', source:'NEW · port of /app/pentacad-sim.html v0.4 (clone of sim.pentamachine.com)', description:'5-axis kinematic simulator · TrackballControls · GLB-or-procedural rig · DRO · auto-hide playback · drag-drop NGC · M0/M30 · stock-removal voxels', category:'pentacad' },

  // -- Phase 1 CAM core (8 strategies + setup) --
  'cam-contour':             { tier:5, minRole:'designer', freeQuota:{calls:Infinity}, cost:{ generate:50 }, deps:['shared/strategies/index.json','shared/cam/widget-base.js'], status:'live', source:'NEW · Phase 1', description:'2D Contour: profile · side · stock-to-leave · per-pass step-down · lead-in/out · G41/G42', category:'pentacad' },
  'cam-pocket':              { tier:5, minRole:'designer', freeQuota:{calls:Infinity}, cost:{ generate:50 }, deps:['shared/strategies/index.json','shared/cam/widget-base.js'], status:'live', source:'NEW · Phase 1', description:'2D Pocket: spiral / zig-zag / parallel · ramp / plunge entry · island avoidance', category:'pentacad' },
  'cam-drill':               { tier:5, minRole:'designer', freeQuota:{calls:Infinity}, cost:{ generate:50 }, deps:['shared/strategies/index.json','shared/cam/widget-base.js'], status:'live', source:'NEW · Phase 1', description:'Drill: peck (G83) · simple (G81) · breakthrough (G82) · tap (G84)', category:'pentacad' },
  'cam-face':                { tier:5, minRole:'designer', freeQuota:{calls:Infinity}, cost:{ generate:50 }, deps:['shared/strategies/index.json','shared/cam/widget-base.js'], status:'live', source:'NEW · Phase 1', description:'Face: linear / spiral / 90° / 45° pattern · top-face stock removal', category:'pentacad' },
  'cam-adaptive':            { tier:5, minRole:'designer', freeQuota:{calls:Infinity}, cost:{ generate:75 }, deps:['shared/strategies/index.json','shared/cam/widget-base.js'], status:'live', source:'NEW · Phase 1', description:'Adaptive Clearing: high-speed roughing · constant tool-engagement · trochoidal motion', category:'pentacad' },
  'cam-chamfer':             { tier:5, minRole:'designer', freeQuota:{calls:Infinity}, cost:{ generate:50 }, deps:['shared/strategies/index.json','shared/cam/widget-base.js'], status:'live', source:'NEW · Phase 1', description:'Chamfer: edge-break with vee or bullnose tool · width / angle / clear-pass', category:'pentacad' },
  'cam-bore':                { tier:5, minRole:'designer', freeQuota:{calls:Infinity}, cost:{ generate:50 }, deps:['shared/strategies/index.json','shared/cam/widget-base.js'], status:'live', source:'NEW · Phase 1', description:'Bore: helical or rigid · concentric ramp · cleanup pass · spring-pass option', category:'pentacad' },
  'cam-thread':              { tier:5, minRole:'designer', freeQuota:{calls:Infinity}, cost:{ generate:75 }, deps:['shared/strategies/index.json','shared/cam/widget-base.js'], status:'live', source:'NEW · Phase 1', description:'Thread Mill: helix · internal/external · metric/unified · single-point or full-form', category:'pentacad' },
  'setup-manager':           { tier:5, minRole:'designer', freeQuota:{calls:Infinity}, cost:{ postAll:200 }, deps:['shared/cam/modal-executor.js'], status:'live', source:'NEW · Phase 1', description:'CAM session: tool table · stock · fixture · drag-reorder ops · postAll · session import/export', category:'pentacad' },

  // -- Phase 2 3D finishing strategies --
  'cam-parallel':            { tier:5, minRole:'designer', freeQuota:{calls:Infinity}, cost:{ generate:100 }, deps:['shared/strategies/index.json','shared/cam/widget-base.js'], status:'live', source:'NEW · Phase 2', description:'3D Parallel: scallop-line sweep across surface · stepover-controlled scallop height', category:'pentacad' },
  'cam-radial':              { tier:5, minRole:'designer', freeQuota:{calls:Infinity}, cost:{ generate:100 }, deps:['shared/strategies/index.json','shared/cam/widget-base.js'], status:'live', source:'NEW · Phase 2', description:'3D Radial: concentric arcs around centre · ideal for round bosses / pockets', category:'pentacad' },
  'cam-scallop':             { tier:5, minRole:'designer', freeQuota:{calls:Infinity}, cost:{ generate:100 }, deps:['shared/strategies/index.json','shared/cam/widget-base.js'], status:'live', source:'NEW · Phase 2', description:'3D Scallop: constant-scallop spiral · curvature-adaptive stepover', category:'pentacad' },
  'cam-projection':          { tier:5, minRole:'designer', freeQuota:{calls:Infinity}, cost:{ generate:100 }, deps:['shared/strategies/index.json','shared/cam/widget-base.js'], status:'live', source:'NEW · Phase 2', description:'3D Projection: project a 2D pattern (curve / drawing) onto a 3D surface', category:'pentacad' },
  'cam-flow':                { tier:5, minRole:'designer', freeQuota:{calls:Infinity}, cost:{ generate:100 }, deps:['shared/strategies/index.json','shared/cam/widget-base.js'], status:'draft', source:'NEW · Phase 2 (deferred kernel — synthetic demo)', description:'3D Flow: surface u/v parameter-line finishing (deferred until OCCT WASM lands)', category:'pentacad' },

  // -- Phase 3 production-ready --
  'collision-check':         { tier:5, minRole:'engineer', freeQuota:{calls:Infinity}, cost:{ check:200 }, deps:['shared/cam/modal-executor.js'], status:'live', source:'NEW · Phase 3', description:'bbox-vs-fixture sweep · per-line hit list · severity classification', category:'pentacad' },
  'probe-g38':               { tier:5, minRole:'engineer', freeQuota:{calls:Infinity}, cost:{ generate:50 }, deps:[], status:'live', source:'NEW · Phase 3', description:'G38.x touchoff workflow · edge-finder / surface-Z / centre-finder · safety prologue', category:'pentacad' },
  'offline-queue':           { tier:5, minRole:'engineer', freeQuota:{calls:Infinity}, cost:{ start:25 }, deps:[], status:'live', source:'NEW · Phase 3', description:'queue programs for later execution · resume-from-interrupt · localStorage + server sync', category:'pentacad' },
  'multi-machine-dashboard': { tier:6, minRole:'admin', freeQuota:{calls:Infinity}, cost:{ refresh:5 }, deps:[], status:'live', source:'NEW · Phase 3', description:'multi-bridge connection aggregator · live DRO grid · alarm + program-line per machine', category:'pentacad' },
  'admin-fusion-post':       { tier:6, minRole:'admin', freeQuota:{calls:Infinity}, cost:{}, deps:[], status:'live', source:'NEW · Phase 3', description:'Penta Machine Fusion 360 post · download · install instructions for Fusion / Inventor / Mastercam', category:'pentacad' },
};
