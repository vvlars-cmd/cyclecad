/**
 * @file widgets/admin-agents.js
 * @description Admin · MCP tool calls · LLM cost breakdown
 * @author  Sachin Kumar
 * @license MIT
 */
...
export async function init(opts) {
  ...
  if (!root) throw new Error('admin-agents: mount not found');

  const dom = document.createElement('div');
  dom.className = 'pt-admin-agents';
  ...
  dom.innerHTML = `
    <div style="font:600 11px Inter;color:#E11D48;letter-spacing:3px;margin-bottom:6px">ADMIN-AGENTS</div>
    <div style="font:600 18px Georgia;margin-bottom:8px">Admin · MCP tool calls · LLM cost breakdown</div>
