/**
 * @file widgets/admin-api-keys.js
 * @description Admin · generate / scope / revoke API keys
 * @author  Sachin Kumar
 * @license MIT
 */
...
export async function init(opts) {
  ...
  if (!root) throw new Error('admin-api-keys: mount not found');

  const dom = document.createElement('div');
  dom.className = 'pt-admin-api-keys';
  ...
  dom.innerHTML = `
    <div style="font:600 11px Inter;color:#E11D48;letter-spacing:3px;margin-bottom:6px">ADMIN-API-KEYS</div>
    <div style="font:600 18px Georgia;margin-bottom:8px">Admin · generate / scope / revoke API keys</div>
