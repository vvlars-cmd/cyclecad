/**
 * @file widgets/admin-compliance.js
 * @description Admin · SOC-2 evidence · GDPR exports
 * @author  Sachin Kumar
 * @license MIT
 */
...
export async function init(opts) {
  ...
  if (!root) throw new Error('admin-compliance: mount not found');

  const dom = document.createElement('div');
  dom.className = 'pt-admin-compliance';
  ...
  dom.innerHTML = `
    <div style="font:600 11px Inter;color:#E11D48;letter-spacing:3px;margin-bottom:6px">ADMIN-COMPLIANCE</div>
    <div style="font:600 18px Georgia;margin-bottom:8px">Admin · SOC-2 evidence · GDPR exports</div>
  ...
  async function run(params = {}) {
    ...
    const result = {
      ...
      params, widget: 'admin-compliance',
    };
