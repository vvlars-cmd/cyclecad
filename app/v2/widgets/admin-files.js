/**
 * @file widgets/admin-files.js
 * @description Admin · S3 / MinIO browser per tenant
 * @author  Sachin Kumar
 * @license MIT
 */
...
export async function init(opts) {
  ...
  if (!root) throw new Error('admin-files: mount not found');

  const dom = document.createElement('div');
  dom.className = 'pt-admin-files';
  ...
  dom.innerHTML = `
    <div style="font:600 11px Inter;color:#E11D48;letter-spacing:3px;margin-bottom:6px">ADMIN-FILES</div>
    <div style="font:600 18px Georgia;margin-bottom:8px">Admin · S3 / MinIO browser per tenant</div>
