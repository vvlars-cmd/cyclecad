/**
 * @file widgets/admin-health.js
 * @description Admin · service status · error logs
 * @author  Sachin Kumar
 * @license MIT
 */
...
export async function init(opts) {
  ...
  if (!root) throw new Error('admin-health: mount not found');

  const dom = document.createElement('div');
  dom.className = 'pt-admin-health';
  ...
  dom.innerHTML = `
    <div style="font:600 11px Inter;color:#E11D48;letter-spacing:3px;margin-bottom:6px">ADMIN-HEALTH</div>
    <div style="font:600 18px Georgia;margin-bottom:8px">Admin · service status · error logs</div>
