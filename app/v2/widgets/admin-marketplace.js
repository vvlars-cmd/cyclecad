/**
 * @file widgets/admin-marketplace.js
 * @description Admin · pending listings · royalty payouts
 * @author  Sachin Kumar
 * @license MIT
 */
...
export async function init(opts) {
  ...
  if (!root) throw new Error('admin-marketplace: mount not found');

  const dom = document.createElement('div');
  dom.className = 'pt-admin-marketplace';
  ...
  dom.innerHTML = `
    <div style="font:600 11px Inter;color:#E11D48;letter-spacing:3px;margin-bottom:6px">ADMIN-MARKETPLACE</div>
    <div style="font:600 18px Georgia;margin-bottom:8px">Admin · pending listings · royalty payouts</div>
  ...
  async function run(params = {}) {
    ...
    const result = {
      ...
      params, widget: 'admin-marketplace',
    };
