/**
 * @file widgets/admin-ops.js
 * @description Admin · backups · migrations · feature flags
 * @author  Sachin Kumar
 * @license MIT
 */
...
export async function init(opts) {
  ...
  if (!root) throw new Error('admin-ops: mount not found');

  const dom = document.createElement('div');
  dom.className = 'pt-admin-ops';
  ...
  dom.innerHTML = `
    <div style="font:600 11px Inter;color:#E11D48;letter-spacing:3px;margin-bottom:6px">ADMIN-OPS</div>
    <div style="font:600 18px Georgia;margin-bottom:8px">Admin · backups · migrations · feature flags</div>
