/**
 * @file widgets/admin-payments.js
 * @description Admin · Stripe webhooks · failed charges
 * @author  Sachin Kumar
 * @license MIT
 */
...
export async function init(opts) {
  ...
  if (!root) throw new Error('admin-payments: mount not found');

  const dom = document.createElement('div');
  dom.className = 'pt-admin-payments';
  ...
  dom.innerHTML = `
    <div style="font:600 11px Inter;color:#E11D48;letter-spacing:3px;margin-bottom:6px">ADMIN-PAYMENTS</div>
    <div style="font:600 18px Georgia;margin-bottom:8px">Admin · Stripe webhooks · failed charges</div>
