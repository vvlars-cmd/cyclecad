/**
 * @file widgets/admin-realtime.js
 * @description Admin · live tail of meter calls + errors
 * @author  Sachin Kumar
 * @license MIT
 */
...
export async function init(opts) {
  ...
  if (!root) throw new Error('admin-realtime: mount not found');

  const dom = document.createElement('div');
  dom.className = 'pt-admin-realtime';
  ...
  dom.innerHTML = `
    <div style="font:600 11px Inter;color:#E11D48;letter-spacing:3px;margin-bottom:6px">ADMIN-REALTIME</div>
    <div style="font:600 18px Georgia;margin-bottom:8px">Admin · live tail of meter calls + errors</div>
