/**
 * @file widgets/admin-repo.js
 * @description Admin · git log · last deploy · rollback
 * @author  Sachin Kumar
 * @license MIT
 */
...
export async function init(opts) {
  ...
  if (!root) throw new Error('admin-repo: mount not found');

  const dom = document.createElement('div');
  dom.className = 'pt-admin-repo';
  ...
  dom.innerHTML = `
    <div style="font:600 11px Inter;color:#E11D48;letter-spacing:3px;margin-bottom:6px">ADMIN-REPO</div>
    <div style="font:600 18px Georgia;margin-bottom:8px">Admin · git log · last deploy · rollback</div>
