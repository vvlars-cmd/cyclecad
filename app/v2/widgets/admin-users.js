/**
 * @file widgets/admin-users.js
 * @description Admin · users · invite · role-assign · disable
 * @author  Sachin Kumar
 * @license MIT
 */
...
export async function init(opts) {
  ...
  if (!root) throw new Error('admin-users: mount not found');

  const dom = document.createElement('div');
  dom.className = 'pt-admin-users';
  ...
  dom.innerHTML = `
    <div style="font:600 11px Inter;color:#E11D48;letter-spacing:3px;margin-bottom:6px">ADMIN-USERS</div>
    <div style="font:600 18px Georgia;margin-bottom:8px">Admin · users · invite · role-assign · disable</div>
