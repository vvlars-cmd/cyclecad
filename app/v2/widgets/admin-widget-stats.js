/**
 * @file widgets/admin-widget-stats.js
 * @description Admin · P50/P95/P99 · errors · top callers
 * @author  Sachin Kumar
 * @license MIT
 */
...
export async function init(opts) {
  ...
  if (!root) throw new Error('admin-widget-stats: mount not found');

  const dom = document.createElement('div');
  dom.className = 'pt-admin-widget-stats';
  ...
  dom.innerHTML = `
    <div style="font:600 11px Inter;color:#E11D48;letter-spacing:3px;margin-bottom:6px">ADMIN-WIDGET-STATS</div>
    <div style="font:600 18px Georgia;margin-bottom:8px">Admin · P50/P95/P99 · errors · top callers</div>
  ...
  async function run(params = {}) {
    ...
    const result = {
      ...
      params, widget: 'admin-widget-stats',
    };
