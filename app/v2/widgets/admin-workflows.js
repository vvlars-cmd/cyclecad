/**
 * @file widgets/admin-workflows.js
 * @description Admin · workflow run history · success rate
 * @author  Sachin Kumar
 * @license MIT
 */
...
export async function init(opts) {
  ...
  if (!root) throw new Error('admin-workflows: mount not found');

  const dom = document.createElement('div');
  dom.className = 'pt-admin-workflows';
  ...
  dom.innerHTML = `
    <div style="font:600 11px Inter;color:#E11D48;letter-spacing:3px;margin-bottom:6px">ADMIN-WORKFLOWS</div>
    <div style="font:600 18px Georgia;margin-bottom:8px">Admin · workflow run history · success rate</div>
