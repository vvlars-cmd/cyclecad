/**
 * @file widgets/ai-batch-scan.js
 * @description AI · bulk classify every part
 * @author  Sachin Kumar
 * @license MIT
 */
...
export async function init(opts) {
  ...
  if (!root) throw new Error('ai-batch-scan: mount not found');

  const dom = document.createElement('div');
  dom.className = 'pt-ai-batch-scan';
  ...
  dom.innerHTML = `
    <div style="font:600 11px Inter;color:#7C3AED;letter-spacing:3px;margin-bottom:6px">AI-BATCH-SCAN</div>
    <div style="font:600 18px Georgia;margin-bottom:8px">AI · bulk classify every part</div>
