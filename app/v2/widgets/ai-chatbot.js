...
export async function init(opts) {
  ...
  if (!root) throw new Error('ai-chatbot: mount not found');

  const dom = document.createElement('div');
  dom.className = 'pt-ai-chatbot';
  ...
  dom.innerHTML = `
    <div style="font:600 11px Inter;color:#7C3AED;letter-spacing:3px;margin-bottom:6px">AI-CHATBOT</div>
    <div style="font:600 18px Georgia;margin-bottom:8px">AI · conversational assistant</div>
