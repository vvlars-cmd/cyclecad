/**
 * @file widgets/ai-copilot.js
 * @description AI · NL → CAD geometry composer
 * @author  Sachin Kumar
 * @license MIT
 */
...
export async function init(opts) {
  ...
  if (!root) throw new Error('ai-copilot: mount not found');

  const dom = document.createElement('div');
  dom.className = 'pt-ai-copilot';
  ...
  dom.innerHTML = `
    <div style="font:600 11px Inter;color:#7C3AED;letter-spacing:3px;margin-bottom:6px">AI-COPILOT</div>
    <div style="font:600 18px Georgia;margin-bottom:8px">AI · NL → CAD geometry composer</div>
