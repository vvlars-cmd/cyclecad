/**
 * @file widgets/ai-engineering-analyst.js
 * @description AI · bolted-joint / gear / shaft analysis
 * @author  Sachin Kumar
 * @license MIT
 */
...
export async function init(opts) {
  ...
  if (!root) throw new Error('ai-engineering-analyst: mount not found');

  const dom = document.createElement('div');
  dom.className = 'pt-ai-engineering-analyst';
  ...
  dom.innerHTML = `
    <div style="font:600 11px Inter;color:#7C3AED;letter-spacing:3px;margin-bottom:6px">AI-ENGINEERING-ANALYST</div>
    <div style="font:600 18px Georgia;margin-bottom:8px">AI · bolted-joint / gear / shaft analysis</div>
    ...
    <button data-run style="background:#7C3AED;color:#fff;border:none;padding:6px 14px;border-radius:4px;font:600 11px Inter;cursor:pointer">RUN</button>
  ...
  async function run(params = {}) {
    ...
    const result = {
      ...
      params, widget: 'ai-engineering-analyst',
    };
