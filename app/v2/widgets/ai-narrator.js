/**
 * @file widgets/ai-narrator.js
 * @description AI · part narrator (geometry + failure modes)
 * @author  Sachin Kumar
 * @license MIT
 */
...
export async function init(opts) {
  ...
  if (!root) throw new Error('ai-narrator: mount not found');

  const dom = document.createElement('div');
  dom.className = 'pt-ai-narrator';
  ...
  dom.innerHTML = `
    <div style="font:600 11px Inter;color:#7C3AED;letter-spacing:3px;margin-bottom:6px">AI-NARRATOR</div>
    <div style="font:600 18px Georgia;margin-bottom:8px">AI · part narrator (geometry + failure modes)</div>
