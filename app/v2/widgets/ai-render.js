/**
 * @file widgets/ai-render.js
 * @description AI · preservation-first scene render
 * @author  Sachin Kumar
 * @license MIT
 */
...
export async function init(opts) {
  ...
  if (!root) throw new Error('ai-render: mount not found');

  const dom = document.createElement('div');
  dom.className = 'pt-ai-render';
  ...
  dom.innerHTML = `
    <div style="font:600 11px Inter;color:#7C3AED;letter-spacing:3px;margin-bottom:6px">AI-RENDER</div>
    <div style="font:600 18px Georgia;margin-bottom:8px">AI · preservation-first scene render</div>
