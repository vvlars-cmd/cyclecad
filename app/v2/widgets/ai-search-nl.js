/**
 * @file widgets/ai-search-nl.js
 * @description AI · natural-language part search
 * @author  Sachin Kumar
 * @license MIT
 */
...
export async function init(opts) {
  ...
  if (!root) throw new Error('ai-search-nl: mount not found');

  const dom = document.createElement('div');
  dom.className = 'pt-ai-search-nl';
  ...
  dom.innerHTML = `
    <div style="font:600 11px Inter;color:#7C3AED;letter-spacing:3px;margin-bottom:6px">AI-SEARCH-NL</div>
    <div style="font:600 18px Georgia;margin-bottom:8px">AI · natural-language part search</div>
