/**
 * @file widgets/ai-vision-id.js
 * @description AI · photo → standard part ID
 * @author  Sachin Kumar
 * @license MIT
 */
...
export async function init(opts) {
  ...
  if (!root) throw new Error('ai-vision-id: mount not found');

  const dom = document.createElement('div');
  dom.className = 'pt-ai-vision-id';
  ...
  dom.innerHTML = `
    <div style="font:600 11px Inter;color:#7C3AED;letter-spacing:3px;margin-bottom:6px">AI-VISION-ID</div>
    <div style="font:600 18px Georgia;margin-bottom:8px">AI · photo → standard part ID</div>
