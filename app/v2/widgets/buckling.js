/**
 * @file widgets/buckling.js
 * @description Analysis · buckling load factor
 * @author  Sachin Kumar
 * @license MIT
 */
...
export async function init(opts) {
  ...
  if (!root) throw new Error('buckling: mount not found');

  const dom = document.createElement('div');
  dom.className = 'pt-buckling';
  ...
  dom.innerHTML = `
    <div style="font:600 11px Inter;color:#7C3AED;letter-spacing:3px;margin-bottom:6px">BUCKLING</div>
    <div style="font:600 18px Georgia;margin-bottom:8px">Analysis · buckling load factor</div>
