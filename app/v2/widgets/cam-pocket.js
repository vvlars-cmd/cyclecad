 ...
 * @description CAM · pocket milling with offsets
 * @author  Sachin Kumar
 * @license MIT
 */
...
export async function init(opts) {
  ...
  if (!root) throw new Error('cam-pocket: mount not found');
  ...
  dom.innerHTML = `
    <div style="font:600 11px Inter;color:#E11D48;letter-spacing:3px;margin-bottom:6px">CAM-POCKET</div>
    <div style="font:600 18px Georgia;margin-bottom:8px">CAM · pocket milling with offsets</div>
