/**
 * @file widgets/combine.js
 * @description Solid op · CSG union/cut/intersect. Generates a transformed BufferGeometry
...
export async function init(opts) {
  ...
  if (!target) throw new Error('combine: opts.target required');
