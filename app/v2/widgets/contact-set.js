/**
 * @file widgets/contact-set.js
 * @description Assembly · contact-set grouping
 * @author  Sachin Kumar
 * @license MIT
 */
...
export async function init(opts) {
  ...
  if (!root) throw new Error('contact-set: mount not found');

  const dom = document.createElement('div');
  dom.className = 'pt-contact-set';
  ...
  dom.innerHTML = `
    <div style="font:600 11px Inter;color:#3AAFA9;letter-spacing:3px;margin-bottom:6px">CONTACT-SET</div>
    <div style="font:600 18px Georgia;margin-bottom:8px">Assembly · contact-set grouping</div>
