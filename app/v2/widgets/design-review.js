/**
 * @file widgets/design-review.js
 * @description Analysis · A-F design review
 * @author  Sachin Kumar
 * @license MIT
 */
...
export async function init(opts) {
  ...
  if (!root) throw new Error('design-review: mount not found');

  const dom = document.createElement('div');
  dom.className = 'pt-design-review';
  ...
  dom.innerHTML = `
    <div style="font:600 11px Inter;color:#7C3AED;letter-spacing:3px;margin-bottom:6px">DESIGN-REVIEW</div>
    <div style="font:600 18px Georgia;margin-bottom:8px">Analysis · A-F design review</div>
