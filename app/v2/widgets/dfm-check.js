/**
 * @file widgets/dfm-check.js
 * @description Analysis · Design-for-Manufacturing rules
 * @author  Sachin Kumar
 * @license MIT
 */
...
export async function init(opts) {
  ...
  if (!root) throw new Error('dfm-check: mount not found');

  const dom = document.createElement('div');
  dom.className = 'pt-dfm-check';
  ...
  dom.innerHTML = `
    <div style="font:600 11px Inter;color:#7C3AED;letter-spacing:3px;margin-bottom:6px">DFM-CHECK</div>
    <div style="font:600 18px Georgia;margin-bottom:8px">Analysis · Design-for-Manufacturing rules</div>
