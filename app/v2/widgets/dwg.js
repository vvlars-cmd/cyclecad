/**
 * @file widgets/dwg.js
 * @description I/O · DWG export (best-effort)
 * @author  Sachin Kumar
 * @license MIT
 */
...
export async function init(opts) {
  ...
  if (!root) throw new Error('dwg: mount not found');

  const dom = document.createElement('div');
  dom.className = 'pt-dwg';
  ...
  dom.innerHTML = `
    <div style="font:600 11px Inter;color:#F59E0B;letter-spacing:3px;margin-bottom:6px">DWG</div>
    <div style="font:600 18px Georgia;margin-bottom:8px">I/O · DWG export (best-effort)</div>
