/**
 * @file widgets/dxf-export.js
 * @description I/O · 2D sketch / 3D projection drawings
 * @author  Sachin Kumar
 * @license MIT
 */
...
export async function init(opts) {
  ...
  if (!root) throw new Error('dxf-export: mount not found');

  const dom = document.createElement('div');
  dom.className = 'pt-dxf-export';
  ...
  dom.innerHTML = `
    <div style="font:600 11px Inter;color:#F59E0B;letter-spacing:3px;margin-bottom:6px">DXF-EXPORT</div>
    <div style="font:600 18px Georgia;margin-bottom:8px">I/O · 2D sketch / 3D projection drawings</div>
    ...
    <button data-run style="background:#F59E0B;color:#fff;border:none;padding:6px 14px;border-radius:4px;font:600 11px Inter;cursor:pointer">RUN</button>
