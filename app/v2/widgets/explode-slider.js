/**
 * @file widgets/explode-slider.js
 * @description Assembly · separation slider
 * @author  Sachin Kumar
 * @license MIT
 */
...
export async function init(opts) {
  ...
  if (!root) throw new Error('explode-slider: mount not found');

  const dom = document.createElement('div');
  dom.className = 'pt-explode-slider';
  ...
  dom.innerHTML = `
    <div style="font:600 11px Inter;color:#3AAFA9;letter-spacing:3px;margin-bottom:6px">EXPLODE-SLIDER</div>
    <div style="font:600 18px Georgia;margin-bottom:8px">Assembly · separation slider</div>
