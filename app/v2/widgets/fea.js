/**
 * @file widgets/fea.js
 * @description Analysis · linear static FEA · Von Mises
 * @author  Sachin Kumar
 * @license MIT
 */
...
export async function init(opts) {
  ...
  if (!root) throw new Error('fea: mount not found');

  const dom = document.createElement('div');
  dom.className = 'pt-fea';
  ...
  dom.innerHTML = `
    <div style="font:600 11px Inter;color:#7C3AED;letter-spacing:3px;margin-bottom:6px">FEA</div>
    <div style="font:600 18px Georgia;margin-bottom:8px">Analysis · linear static FEA · Von Mises</div>
