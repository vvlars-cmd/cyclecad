/**
 * @file widgets/flange.js
 * @description Sheet metal · flange
 * @author  Sachin Kumar
 * @license MIT
 */
...
export async function init(opts) {
  ...
  if (!root) throw new Error('flange: mount not found');

  const dom = document.createElement('div');
  dom.className = 'pt-flange';
  ...
  dom.innerHTML = `
    <div style="font:600 11px Inter;color:#7C3AED;letter-spacing:3px;margin-bottom:6px">FLANGE</div>
    <div style="font:600 18px Georgia;margin-bottom:8px">Sheet metal · flange</div>
