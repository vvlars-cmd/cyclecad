/**
 * @file widgets/gcode-editor.js
 * @description CAM · syntax-highlighted G-code editor
 * @author  Sachin Kumar
 * @license MIT
 */
...
export async function init(opts) {
  ...
  if (!root) throw new Error('gcode-editor: mount not found');

  const dom = document.createElement('div');
  dom.className = 'pt-gcode-editor';
  ...
  dom.innerHTML = `
    <div style="font:600 11px Inter;color:#E11D48;letter-spacing:3px;margin-bottom:6px">GCODE-EDITOR</div>
    <div style="font:600 18px Georgia;margin-bottom:8px">CAM · syntax-highlighted G-code editor</div>
