/**
 * @file widgets/hole.js
 * @description Solid op · cylindrical hole via CSG. Generates a transformed BufferGeometry
...
export async function init(opts) {
  ...
  if (!target) throw new Error('hole: opts.target required');
  ...
  function run(params = {}) {
    const r = params.r||1, h = params.h||4; const geom = new THREE.CylinderGeometry(r, r, h, 24);
