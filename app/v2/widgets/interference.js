/**
 * @file widgets/interference.js
 * @description Assembly · interference detection
 * @author  Sachin Kumar
 * @license MIT
 */
...
export async function init(opts) {
  ...
  if (!root) throw new Error('interference: mount not found');

  const dom = document.createElement('div');
  dom.className = 'pt-interference';
  ...
  dom.innerHTML = `
    <div style="font:600 11px Inter;color:#3AAFA9;letter-spacing:3px;margin-bottom:6px">INTERFERENCE</div>
    <div style="font:600 18px Georgia;margin-bottom:8px">Assembly · interference detection</div>
