/**
 * @file widgets/jog-pad.js
 * @description CAM · manual jog with step/continuous
 * @author  Sachin Kumar
 * @license MIT
 */
...
export async function init(opts) {
  ...
  if (!root) throw new Error('jog-pad: mount not found');

  const dom = document.createElement('div');
  dom.className = 'pt-jog-pad';
  ...
  dom.innerHTML = `
    <div style="font:600 11px Inter;color:#E11D48;letter-spacing:3px;margin-bottom:6px">JOG-PAD</div>
    <div style="font:600 18px Georgia;margin-bottom:8px">CAM · manual jog with step/continuous</div>
