/**
 * @file widgets/joint.js
 * @description Assembly · joint (revolute / slider / pin-slot)
 * @author  Sachin Kumar
 * @license MIT
 */
...
export async function init(opts) {
  ...
  if (!root) throw new Error('joint: mount not found');

  const dom = document.createElement('div');
  dom.className = 'pt-joint';
  ...
  dom.innerHTML = `
    <div style="font:600 11px Inter;color:#3AAFA9;letter-spacing:3px;margin-bottom:6px">JOINT</div>
    <div style="font:600 18px Georgia;margin-bottom:8px">Assembly · joint (revolute / slider / pin-slot)</div>
