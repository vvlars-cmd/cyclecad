/**
 * @file widgets/kb-article.js
 * @description Doc · KB article from resolved issue
 * @author  Sachin Kumar
 * @license MIT
 */
...
export async function init(opts) {
  ...
  if (!root) throw new Error('kb-article: mount not found');

  const dom = document.createElement('div');
  dom.className = 'pt-kb-article';
  ...
  dom.innerHTML = `
    <div style="font:600 11px Inter;color:#3AAFA9;letter-spacing:3px;margin-bottom:6px">KB-ARTICLE</div>
    <div style="font:600 18px Georgia;margin-bottom:8px">Doc · KB article from resolved issue</div>
