/**
 * @file widgets/kiri-moto-export.js
 * @description Doc · Kiri:Moto FDM/CNC export
 * @author  Sachin Kumar
 * @license MIT
 */
...
export async function init(opts) {
  ...
  if (!root) throw new Error('kiri-moto-export: mount not found');

  const dom = document.createElement('div');
  dom.className = 'pt-kiri-moto-export';
  ...
  dom.innerHTML = `
    <div style="font:600 11px Inter;color:#3AAFA9;letter-spacing:3px;margin-bottom:6px">KIRI-MOTO-EXPORT</div>
    <div style="font:600 18px Georgia;margin-bottom:8px">Doc · Kiri:Moto FDM/CNC export</div>
  ...
  async function run(params = {}) {
    ...
    const result = {
      ...
      params, widget: 'kiri-moto-export',
    };
