/**
 * @file widgets/loft.js
 * @description Solid op · loft between profiles. Generates a transformed BufferGeometry
...
export async function init(opts) {
  ...
  if (!target) throw new Error('loft: opts.target required');
  ...
  function run(params = {}) {
    const r = params.r||3; const geom = new THREE.ConeGeometry(r, r*1.5, 32);
