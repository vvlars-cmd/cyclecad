/**
 * @file widgets/manual-builder.js
 * @description Doc · auto-generated assembly manual
 * @author  Sachin Kumar
 * @license MIT
 */
...
export async function init(opts) {
  ...
  if (!root) throw new Error('manual-builder: mount not found');

  const dom = document.createElement('div');
  dom.className = 'pt-manual-builder';
  ...
  dom.innerHTML = `
    <div style="font:600 11px Inter;color:#3AAFA9;letter-spacing:3px;margin-bottom:6px">MANUAL-BUILDER</div>
    <div style="font:600 18px Georgia;margin-bottom:8px">Doc · auto-generated assembly manual</div>
    ...
    <button data-run style="background:#3AAFA9;color:#fff;border:none;padding:6px 14px;border-radius:4px;font:600 11px Inter;cursor:pointer">RUN</button>
