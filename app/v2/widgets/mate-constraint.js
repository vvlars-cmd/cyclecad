/**
 * @file widgets/mate-constraint.js
 * @description Assembly · mate constraint
 * @author  Sachin Kumar
 * @license MIT
 */
...
export async function init(opts) {
  ...
  if (!root) throw new Error('mate-constraint: mount not found');

  const dom = document.createElement('div');
  dom.className = 'pt-mate-constraint';
  ...
  dom.innerHTML = `
    <div style="font:600 11px Inter;color:#3AAFA9;letter-spacing:3px;margin-bottom:6px">MATE-CONSTRAINT</div>
    <div style="font:600 18px Georgia;margin-bottom:8px">Assembly · mate constraint</div>
