/**
 * @file widgets/mcmaster-search.js
 * @description Doc · McMaster-Carr search URL
 * @author  Sachin Kumar
 * @license MIT
 */
...
export async function init(opts) {
  ...
  if (!root) throw new Error('mcmaster-search: mount not found');

  const dom = document.createElement('div');
  dom.className = 'pt-mcmaster-search';
  ...
  dom.innerHTML = `
    <div style="font:600 11px Inter;color:#3AAFA9;letter-spacing:3px;margin-bottom:6px">MCMASTER-SEARCH</div>
    <div style="font:600 18px Georgia;margin-bottom:8px">Doc · McMaster-Carr search URL</div>
