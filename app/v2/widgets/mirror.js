/**
 * @file widgets/mirror.js
 * @description Solid op · mirror across plane. Generates a transformed BufferGeometry
...
export async function init(opts) {
  ...
  if (!target) throw new Error('mirror: opts.target required');
  ...
  function run(params = {}) {
    const r = params.r||3; const geom = new THREE.TetrahedronGeometry(r);
