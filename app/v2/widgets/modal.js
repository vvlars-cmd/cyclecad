/**
 * @file widgets/modal.js
 * @description Analysis · modal frequency
 * @author  Sachin Kumar
 * @license MIT
 */
...
export async function init(opts) {
  ...
  if (!root) throw new Error('modal: mount not found');

  const dom = document.createElement('div');
  dom.className = 'pt-modal';
  ...
  dom.innerHTML = `
    <div style="font:600 11px Inter;color:#7C3AED;letter-spacing:3px;margin-bottom:6px">MODAL</div>
    <div style="font:600 18px Georgia;margin-bottom:8px">Analysis · modal frequency</div>
