/**
 * @file widgets/motion-study.js
 * @description Assembly · animate joints over time
 * @author  Sachin Kumar
 * @license MIT
 */
...
export async function init(opts) {
  ...
  if (!root) throw new Error('motion-study: mount not found');

  const dom = document.createElement('div');
  dom.className = 'pt-motion-study';
  ...
  dom.innerHTML = `
    <div style="font:600 11px Inter;color:#3AAFA9;letter-spacing:3px;margin-bottom:6px">MOTION-STUDY</div>
    <div style="font:600 18px Georgia;margin-bottom:8px">Assembly · animate joints over time</div>
