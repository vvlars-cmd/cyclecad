/**
 * @file widgets/nurbs.js
 * @description Surface · NURBS surface tools
 * @author  Sachin Kumar
 * @license MIT
 */
...
export async function init(opts) {
  ...
  if (!root) throw new Error('nurbs: mount not found');

  const dom = document.createElement('div');
  dom.className = 'pt-nurbs';
  ...
  dom.innerHTML = `
    <div style="font:600 11px Inter;color:#7C3AED;letter-spacing:3px;margin-bottom:6px">NURBS</div>
    <div style="font:600 18px Georgia;margin-bottom:8px">Surface · NURBS surface tools</div>
