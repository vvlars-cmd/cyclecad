/**
 * @file widgets/occt-wasm.js
 * @description I/O · OCCT WASM kernel · lazy-loaded
 * @author  Sachin Kumar
 * @license MIT
 */
...
export async function init(opts) {
  ...
  if (!root) throw new Error('occt-wasm: mount not found');

  const dom = document.createElement('div');
  dom.className = 'pt-occt-wasm';
  ...
  dom.innerHTML = `
    <div style="font:600 11px Inter;color:#F59E0B;letter-spacing:3px;margin-bottom:6px">OCCT-WASM</div>
    <div style="font:600 18px Georgia;margin-bottom:8px">I/O · OCCT WASM kernel · lazy-loaded</div>
