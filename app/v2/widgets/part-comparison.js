/**
 * @file widgets/part-comparison.js
 * @description Analysis · side-by-side dimensional diff
 * @author  Sachin Kumar
 * @license MIT
 */
...
export async function init(opts) {
  ...
  if (!root) throw new Error('part-comparison: mount not found');

  const dom = document.createElement('div');
  dom.className = 'pt-part-comparison';
  ...
  dom.innerHTML = `
    <div style="font:600 11px Inter;color:#7C3AED;letter-spacing:3px;margin-bottom:6px">PART-COMPARISON</div>
    <div style="font:600 18px Georgia;margin-bottom:8px">Analysis · side-by-side dimensional diff</div>
