/**
 * @file widgets/pdf-export.js
 * @description I/O · paper-size PDF with title block
 * @author  Sachin Kumar
 * @license MIT
 */
...
export async function init(opts) {
  ...
  if (!root) throw new Error('pdf-export: mount not found');

  const dom = document.createElement('div');
  dom.className = 'pt-pdf-export';
  ...
  dom.innerHTML = `
    <div style="font:600 11px Inter;color:#F59E0B;letter-spacing:3px;margin-bottom:6px">PDF-EXPORT</div>
    <div style="font:600 18px Georgia;margin-bottom:8px">I/O · paper-size PDF with title block</div>
