/**
 * @file widgets/playback.js
 * @description CAM · transport bar
 * @author  Sachin Kumar
 * @license MIT
 */
...
export async function init(opts) {
  ...
  if (!root) throw new Error('playback: mount not found');

  const dom = document.createElement('div');
  dom.className = 'pt-playback';
  ...
  dom.innerHTML = `
    <div style="font:600 11px Inter;color:#E11D48;letter-spacing:3px;margin-bottom:6px">PLAYBACK</div>
    <div style="font:600 18px Georgia;margin-bottom:8px">CAM · transport bar</div>
