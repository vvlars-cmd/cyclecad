/**
 * @file widgets/qr-code.js
 * @description Doc · QR per part with deep-link
 * @author  Sachin Kumar
 * @license MIT
 */
...
export async function init(opts) {
  ...
  if (!root) throw new Error('qr-code: mount not found');

  const dom = document.createElement('div');
  dom.className = 'pt-qr-code';
  ...
  dom.innerHTML = `
    <div style="font:600 11px Inter;color:#3AAFA9;letter-spacing:3px;margin-bottom:6px">QR-CODE</div>
    <div style="font:600 18px Georgia;margin-bottom:8px">Doc · QR per part with deep-link</div>
