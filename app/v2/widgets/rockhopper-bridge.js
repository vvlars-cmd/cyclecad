/**
 * @file widgets/rockhopper-bridge.js
 * @description CAM · Rockhopper / LinuxCNC bridge
 * @author  Sachin Kumar
 * @license MIT
 */
...
export async function init(opts) {
  ...
  if (!root) throw new Error('rockhopper-bridge: mount not found');

  const dom = document.createElement('div');
  dom.className = 'pt-rockhopper-bridge';
  ...
  dom.innerHTML = `
    <div style="font:600 11px Inter;color:#E11D48;letter-spacing:3px;margin-bottom:6px">ROCKHOPPER-BRIDGE</div>
    <div style="font:600 18px Georgia;margin-bottom:8px">CAM · Rockhopper / LinuxCNC bridge</div>
  ...
  async function run(params = {}) {
    ...
    const result = {
      ...
      params, widget: 'rockhopper-bridge',
    };
