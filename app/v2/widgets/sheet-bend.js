/**
 * @file widgets/sheet-bend.js
 * @description Sheet metal · bend with k-factor
 * @author  Sachin Kumar
 * @license MIT
 */
...
export async function init(opts) {
  ...
  if (!root) throw new Error('sheet-bend: mount not found');

  const dom = document.createElement('div');
  dom.className = 'pt-sheet-bend';
  ...
  dom.innerHTML = `
    <div style="font:600 11px Inter;color:#7C3AED;letter-spacing:3px;margin-bottom:6px">SHEET-BEND</div>
    <div style="font:600 18px Georgia;margin-bottom:8px">Sheet metal · bend with k-factor</div>
