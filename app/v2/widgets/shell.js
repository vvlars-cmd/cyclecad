/**
 * @file widgets/shell.js
 * @description Solid op · hollow body. Generates a transformed BufferGeometry
...
export async function init(opts) {
  ...
  if (!target) throw new Error('shell: opts.target required');
