/**
 * @file widgets/sim-executor.js
 * @description CAM · G-code parser + executor
 * @author  Sachin Kumar
 * @license MIT
 */
...
export async function init(opts) {
  ...
  if (!root) throw new Error('sim-executor: mount not found');

  const dom = document.createElement('div');
  dom.className = 'pt-sim-executor';
  ...
  dom.innerHTML = `
    <div style="font:600 11px Inter;color:#E11D48;letter-spacing:3px;margin-bottom:6px">SIM-EXECUTOR</div>
    <div style="font:600 18px Georgia;margin-bottom:8px">CAM · G-code parser + executor</div>
