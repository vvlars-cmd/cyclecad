/**
 * @file widgets/split.js
 * @description Solid op · split body by plane. Generates a transformed BufferGeometry
...
export async function init(opts) {
  ...
  if (!target) throw new Error('split: opts.target required');
  ...
  function run(params = {}) {
    const r = params.r||3; const geom = new THREE.DodecahedronGeometry(r);
