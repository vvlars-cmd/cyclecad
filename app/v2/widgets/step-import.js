/**
 * @file widgets/step-import.js
 * @description I/O · STEP / STP / IPT loader (occt-wasm)
 * @author  Sachin Kumar
 * @license MIT
 */
...
export async function init(opts) {
  ...
  if (!root) throw new Error('step-import: mount not found');

  const dom = document.createElement('div');
  dom.className = 'pt-step-import';
  ...
  dom.innerHTML = `
    <div style="font:600 11px Inter;color:#F59E0B;letter-spacing:3px;margin-bottom:6px">STEP-IMPORT</div>
    <div style="font:600 18px Georgia;margin-bottom:8px">I/O · STEP / STP / IPT loader (occt-wasm)</div>
