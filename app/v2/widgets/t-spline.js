/**
 * @file widgets/t-spline.js
 * @description Surface · T-spline sculpt
 * @author  Sachin Kumar
 * @license MIT
 */
...
export async function init(opts) {
  ...
  if (!root) throw new Error('t-spline: mount not found');

  const dom = document.createElement('div');
  dom.className = 'pt-t-spline';
  ...
  dom.innerHTML = `
    <div style="font:600 11px Inter;color:#7C3AED;letter-spacing:3px;margin-bottom:6px">T-SPLINE</div>
    <div style="font:600 18px Georgia;margin-bottom:8px">Surface · T-spline sculpt</div>
