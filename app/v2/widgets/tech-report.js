/**
 * @file widgets/tech-report.js
 * @description Doc · full HTML technical report
 * @author  Sachin Kumar
 * @license MIT
 */
...
export async function init(opts) {
  ...
  if (!root) throw new Error('tech-report: mount not found');

  const dom = document.createElement('div');
  dom.className = 'pt-tech-report';
  ...
  dom.innerHTML = `
    <div style="font:600 11px Inter;color:#3AAFA9;letter-spacing:3px;margin-bottom:6px">TECH-REPORT</div>
    <div style="font:600 18px Georgia;margin-bottom:8px">Doc · full HTML technical report</div>
