/**
 * @file widgets/thermal.js
 * @description Analysis · steady-state thermal
 * @author  Sachin Kumar
 * @license MIT
 */
...
export async function init(opts) {
  ...
  if (!root) throw new Error('thermal: mount not found');

  const dom = document.createElement('div');
  dom.className = 'pt-thermal';
  ...
  dom.innerHTML = `
    <div style="font:600 11px Inter;color:#7C3AED;letter-spacing:3px;margin-bottom:6px">THERMAL</div>
    <div style="font:600 18px Georgia;margin-bottom:8px">Analysis · steady-state thermal</div>
