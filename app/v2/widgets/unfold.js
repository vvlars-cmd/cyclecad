/**
 * @file widgets/unfold.js
 * @description Sheet metal · flat-pattern unfold
 * @author  Sachin Kumar
 * @license MIT
 */
...
export async function init(opts) {
  ...
  if (!root) throw new Error('unfold: mount not found');

  const dom = document.createElement('div');
  dom.className = 'pt-unfold';
  ...
  dom.innerHTML = `
    <div style="font:600 11px Inter;color:#7C3AED;letter-spacing:3px;margin-bottom:6px">UNFOLD</div>
    <div style="font:600 18px Georgia;margin-bottom:8px">Sheet metal · flat-pattern unfold</div>
